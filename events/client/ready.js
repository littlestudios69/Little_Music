...
module.exports = client => {
  ...
  try{
    try{
      ...
      console.log(`     ┃ `.bold.brightGreen + ` /--/ Shard #${guild.shardID} from ${client.shard.ids.length-1} /--/ `.bold.brightGreen+ " ".repeat(-1+stringlength-` ┃ `.length-` /--/ Shard #${guild.shardID} from ${client.shard.ids.length-1} /--/ `.length)+ "┃".bold.brightGreen)
      console.log(`     ┃ `.bold.brightGreen + " ".repeat(-1+stringlength-` ┃ `.length)+ "┃".bold.brightGreen)
      console.log(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`.bold.brightGreen)
    }catch{ /* */ }
